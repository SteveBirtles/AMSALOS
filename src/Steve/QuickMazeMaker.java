    ...
    public static int[][] fixEdges(int[][] maze) {
        ...
        for (int p = 0; p < width; p++) {
            for (int q = 0; q < height; q++) {
                ...
                boolean solid = maze[p][q]%256 >= 128;
                ...
                boolean north   = q > 0         &&  (solid ? maze[p][q - 1]%256 >= 128 : maze[p][q - 1]%256 < 128);
                boolean south   = q < height-1  &&  (solid ? maze[p][q + 1]%256 >= 128 : maze[p][q + 1]%256 < 128);
                boolean east    = p < width-1   &&  (solid ? maze[p + 1][q]%256 >= 128 : maze[p + 1][q]%256 < 128);
                boolean west    = p > 0         &&  (solid ? maze[p - 1][q]%256 >= 128 : maze[p - 1][q]%256 < 128);

                boolean north_east = q > 0          && p < width-1  &&  (solid ? maze[p + 1][q - 1]%256 >= 128 : maze[p + 1][q - 1]%256 < 128);
                boolean north_west = q > 0          && p > 0        &&  (solid ? maze[p - 1][q - 1]%256 >= 128 : maze[p - 1][q - 1]%256 < 128);
                boolean south_east = q < height-1   && p < width-1  &&  (solid ? maze[p + 1][q + 1]%256 >= 128 : maze[p + 1][q + 1]%256 < 128);
                boolean south_west = q < height-1   && p > 0        &&  (solid ? maze[p - 1][q + 1]%256 >= 128 : maze[p - 1][q + 1]%256 < 128);
